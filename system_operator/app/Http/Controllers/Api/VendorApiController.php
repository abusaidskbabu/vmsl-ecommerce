...
// Product 
	...
	public function order_update(Request $request){
		...
		if($user){
            ...
            $message = [
                    'order_id' =>'NJ'. Carbon::parse($order_details->created_at)->format('y') .$order_details->order_id,
                    'type' =>'order',
            ...
            \Helper::sendSms($user->phone,'আপনার অর্ডার স্ট্যাটাস পরিবর্তন করা হয়েছে! অর্ডার আইডি হল #'.'NJ' . date('y', strtotime(Carbon::now())) .'  অর্ডার স্ট্যাটাস# '.$status->title);
