        ...
        <tr>
            <td style="width: 650px;">
                <div class="row" style="display: flex; -ms-flex-wrap: wrap;flex-wrap: wrap;padding: 0!important;">
                    ...
                    <div class="col-md-6" style="flex: 0 0 45%;max-width: 45%;position: relative;text-align: right!important;padding: 0!important;">  <span style="text-transform: uppercase;font-size: 14px;font-weight: 600;">  Order ID: NJ{{ date("y", strtotime($order->created_at)) }}{{$order->id}} </span> </div>
                </div>
            </td>
        </tr>
    </tbody>
  ...
  <table style="width: 650px;text-align:right; margin:50px auto">
    ...
    <table style="width: 650px;text-align:left; margin:50px auto">
        <tbody style="text-align: center;">
            ...
            <p style="text-align: center;"><img src="data:image/png;base64, {{DNS1D::getBarcodePNG('NJ'.date("y", strtotime($order->created_at)).$order->id, 'C39',5,10) }}" alt=""  width="150px" height="30px"></p>
        </tbody>
    </table>
